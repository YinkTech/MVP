...
class ExternalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create external" do
    assert_difference("External.count") do
      post externals_url, params: { external: { amount: @external.amount, company_name: @external.company_name, products_name: @external.products_name, quantity: @external.quantity } }
    end
  ...
  test "should update external" do
    patch external_url(@external), params: { external: { amount: @external.amount, company_name: @external.company_name, products_name: @external.products_name, quantity: @external.quantity } }
